...
namespace Core.Character
{
    public class CameraController : MonoSingleton<CameraController>
    {
        ...
        [Header("Test")]
        [SerializeField] Collider2D bossCollider;//boss战过程中的相机位
        ...
        public void SetBorders(Collider2D collider)
        {
            CinemachineConfiner confiner = transform.parent.GetComponentInChildren<CinemachineConfiner>();
            confiner.m_BoundingShape2D = bossCollider;
        }
